...
def build_workflow():
    ...
    workflow.add_node("set_brightness_tool", lambda data: execute_tool({**data, "selected_tool": set_brightness_tool}))
    workflow.add_node("set_volume_tool", lambda data: execute_tool({**data, "selected_tool": set_volume_tool}))
    def end_for(data):
        # 打印一些資訊
